...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['https://www.fira.gob.mx', 'https://firanet.fira.gob.mx', 'https://credito.fira.gob.mx'],            // If non-empty, requests not from an origin in this list will be blocked.
...
exports.createServer = function createServer(options) {
  ...
  proxy.on('error', function (err, req, res) {
    ...
    res.writeHead(404, { 'Access-control-expose-headers': '*' });
